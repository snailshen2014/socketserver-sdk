...
/**
 * 
*  @des    :read a whole Frame ,modified by Netty's code,two modifies as :
*  1.implement InnerDecoder interface
*  2.open the interface ByteToMessageDecoder's decode interface
 * @author:shenyanjun1
