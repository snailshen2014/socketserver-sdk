...
public class ServerConnectionChannelHandler extends ChannelInboundHandlerAdapter {

    /**
     * slf4j Logger for this class
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(ServerConnectionChannelHandler.class);

    private final ServerEndpointConfig transportConfig;

    public ServerConnectionChannelHandler(ServerEndpointConfig transportConfig) {
