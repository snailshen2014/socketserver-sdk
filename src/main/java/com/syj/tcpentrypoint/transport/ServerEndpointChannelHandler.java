...
public class ServerEndpointChannelHandler extends ChannelInboundHandlerAdapter {

	private static final Logger logger = LoggerFactory.getLogger(ServerEndpointChannelHandler.class);
...
//    private final List<ConnectListener> connectListeners;
	...
	public ServerEndpointChannelHandler(ServerEndpointConfig serverTransportConfig) {
