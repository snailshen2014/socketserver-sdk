...
public final class EchoClient {
    ...
    static final int PORT = Integer.parseInt(System.getProperty("port", "18550"));
            ...
            b.group(group)
             ...
             .handler(new ChannelInitializer<SocketChannel>() {
                 ...
                 public void initChannel(SocketChannel ch) throws Exception {
                     ...
                     p.addLast(new REEncoder());//encoder
                     p.addLast(new REDecoder(Constants.DEFAULT_PAYLOAD));//decoder
