...
public class ClientEndpointConfig {
	...
	private Endpoint provider; // 对应的Provider信息
	...
	public Endpoint getProvider() {
		return provider;
	}

	public void setProvider(Endpoint provider) {
		this.provider = provider;
	}

	public static EventLoopGroup getEventLoopGroup(ClientEndpointConfig transportConfig) {
	...
	private static synchronized void initEventLoop(ClientEndpointConfig transportConfig) {
		if (eventLoopGroup == null || eventLoopGroup.isShutdown()) {
